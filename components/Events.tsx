          ...
          <div className="flex flex-col gap-4">
            {LIVE_DATES.map((event) => (
              <div 
                ...
                className="group relative py-12 border-b border-black/10 cursor-crosshair transition-all duration-500 hover:pl-8"
              >
                <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
                  ...
                  <div className="flex flex-col items-start md:items-end">
                    <span 
                      className={`text-[11px] font-bold tracking-[0.5em] uppercase transition-all px-4 py-1 border border-transparent ${
