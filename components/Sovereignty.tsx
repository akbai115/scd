  ...
  return (
    <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-auto transition-all duration-1000 animate-in fade-in zoom-in-95">
      ...
      <div className="relative group flex flex-col items-center justify-center gap-10 hover:gap-12 transition-all duration-700 cursor-none">
        {/* Diamond Star */}
        <div className="w-12 h-12 bg-black rotate-45 transition-transform duration-700 group-hover:rotate-[225deg] group-hover:scale-110 shadow-2xl" />

        {/* Brutalist Hull (Semi-Circle) */}
        <div className="w-56 h-28 md:w-80 md:h-40 bg-black rounded-b-full transition-all duration-700 group-hover:scale-[1.02] shadow-2xl relative overflow-hidden">
        ...
        {/* Ambient Glow */}
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-64 h-64 bg-black/5 blur-[100px] -z-10 rounded-full" />
      </div>

      <div className="mt-20 text-center max-w-2xl px-12">
        <div className="flex flex-col gap-6">
          <h3 className="times-bold text-4xl md:text-6xl tracking-tightest text-black opacity-90 leading-none uppercase">
            SECURE THE FUTURE.
          </h3>
          <p className="text-[11px] font-bold tracking-[0.8em] uppercase text-black/60 leading-relaxed max-w-lg mx-auto">
