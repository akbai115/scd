...
export const LoadingScreen: React.FC<LoadingScreenProps> = ({ onComplete }) => {
    ...
    return (
        <div className={`fixed inset-0 z-[9999] bg-[#EBE9E4] flex items-center justify-center transition-opacity duration-1000 ${isComplete ? 'opacity-0' : 'opacity-100'}`}>
            <div className="flex flex-col items-center gap-12">
                ...
                <div className="relative flex flex-col items-center gap-6 animate-pulse">
                    ...
                    <div
                        className="w-16 h-16 bg-black rotate-45 shadow-2xl transition-transform duration-700"
                        style={{
                    ...
                    {/* Brutalist Hull */}
                    <div className="w-32 h-16 bg-black rounded-b-full shadow-2xl relative overflow-hidden">
                        {/* Shine effect */}
                        <div
                ...
                <div className="flex flex-col items-center gap-4">
                    ...
                    {/* Progress Bar */}
                    <div className="w-64 h-[2px] bg-black/10 relative overflow-hidden">
                        <div
