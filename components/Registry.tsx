    ...
    <div className="absolute inset-0 flex flex-col items-center justify-center pointer-events-auto transition-all duration-1000 animate-in fade-in zoom-in-95 px-6">
      <div className="w-full max-w-2xl flex flex-col gap-16">
        ...
        <div className="flex flex-col items-center gap-6 text-center">
          ...
          <div className="w-32 h-[1px] bg-black opacity-20" />
        ...
        {!isSubmitted ? (
          <form onSubmit={handleSubmit} className="flex flex-col gap-10">
            <div className="relative group">
              ...
              <input
                ...
                className="w-full bg-transparent border-b-2 border-black/10 text-2xl font-mono tracking-wide py-6 px-2 outline-none placeholder:opacity-10 focus:border-black transition-all uppercase"
                required
              />
              <div className="absolute bottom-0 left-0 h-[3px] bg-black scale-x-0 group-focus-within:scale-x-100 transition-transform duration-1000 origin-left" />
            </div>

            <div className="flex flex-col gap-4">
              <button
                type="submit"
                className="py-6 bg-black text-[#EBE9E4] text-[11px] font-bold tracking-[1.2em] uppercase hover:invert transition-all active:scale-[0.98] shadow-lg"
              >
          ...
          <div className="flex flex-col items-center gap-10 animate-in fade-in zoom-in-95 duration-700">
            <div className="flex flex-col items-center gap-6">
              <div className="w-20 h-20 border-4 border-black flex items-center justify-center animate-pulse">
