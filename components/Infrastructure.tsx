...
export const Infrastructure: React.FC = () => {
  return (
    <div className="absolute inset-0 flex items-center justify-center pointer-events-none transition-all duration-1000 animate-in zoom-in-95 fade-in">
      <div className="grid grid-cols-2 md:grid-cols-3 gap-16 md:gap-32 text-white opacity-80 max-w-6xl p-12">
        ...
        <div className="flex flex-col gap-4 col-span-full border-t border-white/10 pt-12 mt-8">
